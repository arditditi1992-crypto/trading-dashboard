...
def render_engine():
    ...
    for symbol, ta_data in zip(st.session_state.selected_symbols, ta_data_list):
        ...
        if current_price > 0:
            ...
            # Formatting logic for live tracking
            if long_qty > 0 and entry_price > 0:
                position_type = "LONG"
            ...
            # 1. Add to Active Positions list if holding a trade
            ...
            # 2. Add to Top 10 Live Overview if it's a top 10 coin
